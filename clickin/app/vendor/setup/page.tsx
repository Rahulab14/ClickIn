...
export default function VendorSetupPage() {
  ...
  const [setupUpiError, setSetupUpiError] = useState<string | null>(null);
  ...
  const handleImageUpload = (
    ...
    if (file.size > maxSize) {
      setError(
        `${field === "logo" ? "Logo" : "Banner"} must be under ${field === "logo" ? "5MB" : "7MB"}`,
      );
      return;
    }
    setError("");
  ...
  const toggleArrayItem = (
    field: "workingDays" | "orderTypesSupported",
    item: string,
  ) => {
    setFormData((prev) => {
  ...
  const handleSubmit = async () => {
    ...
    if (!validateUpi(formData.upiId)) {
      setError("Please enter a valid UPI ID before continuing.");
      return;
    }
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden mb-6">
          ...
          {step === 1 && (
            <div className="p-6 md:p-8 animate-in slide-in-from-right-8 duration-300">
              <h2 className="text-xl font-black text-gray-900 mb-6 flex items-center gap-2">
                <Store className="w-5 h-5 text-emerald-500" /> Basic Shop
                Information
              </h2>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <label
                        htmlFor="logoUpload"
                        className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 hover:bg-gray-50 rounded-xl text-sm font-bold text-gray-700 cursor-pointer transition-colors"
                      >
                        <Upload className="w-4 h-4" /> Upload Logo
                      </label>
                      <p className="text-xs text-gray-400 font-medium mt-1">
                        Max 5MB. Used as your shop icon.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          {step === 2 && (
            <div className="p-6 md:p-8 animate-in slide-in-from-right-8 duration-300">
              <h2 className="text-xl font-black text-gray-900 mb-6 flex items-center gap-2">
                <CreditCard className="w-5 h-5 text-emerald-500" /> Contact
                Information
              </h2>
              <div className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-gray-400 font-medium">
                    Used for order issues and customer support.
                  </p>
                </div>
                <div className="space-y-2">
                  <label className="block text-sm font-bold text-gray-700">
              ...
              <div className="space-y-5">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData((p) => ({ ...p, campus: e.target.value }))
                    }
                    className="h-12 bg-gray-50/50"
                  />
                </div>
          ...
          {step === 4 && (
            <div className="p-6 md:p-8 animate-in slide-in-from-right-8 duration-300">
              <h2 className="text-xl font-black text-gray-900 mb-6 flex items-center gap-2">
                <Clock className="w-5 h-5 text-emerald-500" /> Operating &
                Payment Details
              </h2>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      {["Pickup", "Pre-Order", "Dine-in", "Delivery"].map(
                        (type) => (
                          <button
                            key={type}
                            onClick={() =>
                              toggleArrayItem("orderTypesSupported", type)
                            }
                            className={cn(
                              "px-4 py-2 rounded-xl text-sm font-bold transition-all border",
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-[10px] text-gray-400 mt-1">
                      Provide a merchant UPI handle – GPay may reject personal
                      IDs.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setFormData((p) => ({
                            ...p,
                            averagePrepTime: parseInt(e.target.value),
                          }))
                        }
                        className="h-12 bg-gray-50/50"
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        type="number"
                        min={1}
                        value={formData.orderQueueLimit}
                        onChange={(e) =>
                          setFormData((p) => ({
                            ...p,
                            orderQueueLimit: parseInt(e.target.value),
                          }))
                        }
                        className="h-12 bg-gray-50/50"
                      />
          ...
          <div className="bg-gray-50/80 p-6 border-t border-gray-100 flex items-center justify-between">
            {step > 1 ? (
              <Button
                variant="outline"
                onClick={prevStep}
                className="font-bold border-gray-300 text-gray-600 px-6 h-12 rounded-xl hover:bg-white hover:text-gray-900"
              >
            ...
            {step < 4 ? (
              <Button
                onClick={nextStep}
                className="bg-gray-900 text-white hover:bg-gray-800 font-bold px-8 h-12 rounded-xl shadow-md"
              >
              ...
              <Button
                ...
                className="bg-emerald-600 text-white hover:bg-emerald-700 font-black px-8 h-12 rounded-xl shadow-lg shadow-emerald-200"
              >
